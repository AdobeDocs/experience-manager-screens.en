...
If you want the zones to display sequence of images or content and a static image in two different zones, please follow steps below for details.
...
### Creating Location and Display {#creating-location}
...
1. **Registering the Device**
   ...
   1. If the title matches the device token, select the device and click **Register Device** from the action bar.
   1. If the registration code matches the code in the Screens player registration tab, click **Validate** from the action bar.
