...
description: Learn more about the AEM Screens Players and their respective AEM Screens version.
...
>[!NOTE]
>
>The following information was updated as of May 14, 2018.
...
## Android&trade; Player {#android-player}

| **AEM Server Version** |**Android&trade; Player** |
|---|---|
...
<table>
 <tbody>
  <tr>
   ...
   <td><strong>Android&trade; Player</strong></td> 
  </tr>
  <tr>
   <td><strong>AEM 6.3+SP1+Screens FP1(1.0.64_B002)</strong></td> 
   ...
   <td><p><strong>1.0.30 -</strong> Available on Chrome Store.</p> <p>Not Supported with Feature Pack 1</p> </td> 
