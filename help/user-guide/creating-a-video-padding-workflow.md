...
1. After you create the workflow model, click the model (**VideoRendition**), and click **Edit** from the action bar.
...
1. Click the **`Command Line`** component and open the properties dialog box.
...
1. Click the workflow (**VideoRenditions**).
1. Click **Start Workflow** from the action bar.

   ![screen_shot_2018-10-18at105335am](assets/screen_shot_2018-10-18at105335am.png)

1. In the **Run Workflow** dialog box, click the path of your asset in the **Payload** (as ***/content/dam/huseinpeyda-crossroads01_512kb 2.mp4***) and enter the **Title** as ***RunVideo*** and click **Run**.
