...
* **Estimating Desired Outcome**:
 Start with out-of-the-box AEM Screens features before building custom components and integrations. Can the desired outcome be reached using the components and features that come standard with AEM Screens?
...
* **Pre-defining Content Strategy**:
 Establish a content strategy, including short-term goals and long-term goals. Align brand goals/KPIs with feature improvements.

  >[!NOTE]
  >
  > Upfront costs are often higher on a Screen project due to need to invest in hardware, fixtures, and site designs; therefore, keeping initial content solutions simpler can help manage budget expectations.
...
* **Splitting Devliverables into measurable tasks**:
